import { AvailableCreditCard } from "./AvailableCreditsCard"
...
<aside id="default-sidebar"  class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full lg:translate-x-0 " aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-slate-800 space-y-2">
      <ul class=" font-normal">
        <div>
            <StoreCard storename={"flipkart"}/>
        </div>
         <li>
         ...
         <li>
            <a class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 bg-gray-700 dark:hover:bg-gray-700 group">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
      ...
      <div className="pt-20">
        <AvailableCreditCard credits={330.28}/>
